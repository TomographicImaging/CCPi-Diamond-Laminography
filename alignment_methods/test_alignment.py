...
data = NEXUSDataReader(file_name='../output_data/cylinder_nonoise360.nxs').read()
ag = data.geometry
show_geometry(ag)
islicer(data)
# %% 
...
tilt = 25
tilt_direction = np.array([0, 1, 0]) # I don't understand
...
ag.config.system.rotation_axis.direction = rotation_axis
